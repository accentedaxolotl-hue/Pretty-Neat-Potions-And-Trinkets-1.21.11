...
public class ReinforcedChestplate extends Item implements IAccessory {
    public ReinforcedChestplate(Item.Properties properties) {
        super(properties);
    }
    ...
    public void tick(Player player, ItemStack stack) {
        ...
        if (hasTNT(player) && (!(player.hasEffect(MobEffects.SLOWNESS)))) {
